                ...
                <div class="row top-part">
                    <div class="col-sm-3 col-md-3">
                        <a href="{{ lang_url('/') }}" class="logo-container">
                            <img src="http://www.eatlogos.com/food_and_drinks/png/vector_coffee_seed_shop_logo_inspiration.png" class="img-responsive logo" alt="{{ $head_title }}">
                        </a>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3">
                        <div class="phone-call">
                            <a href="https://wa.me/6281281034103?text=Saya%20tertarik%20untuk%20membeli" class="logo-container">
                            <img src="{{ asset('img/phone.png') }}" alt="{{ $head_title }}">
                            <div class="right">
                                <p>{{__('public_pages.phone_order')}}</p>
                                <span>081281034103</span>
                            </div>
                           </a>
